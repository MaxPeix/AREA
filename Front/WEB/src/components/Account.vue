<template>
  <div class="wrapper" :style="{ backgroundColor: currentTheme.backgroundColor }">
      ...
      <div class="left-rectangle">
          ...
          <div class="apps">
            <div class="app-item">
              <img :src="overview" @click="moveToOverview"/>
              <span class="image-name">Overview</span>
            </div>
            <div class="app-item">
              <img :src="discord" @click="moveToDiscord"/>
              <span class="image-name">Discord</span>
            </div>
            <div class="app-item">
              <img :src="twitch" @click="moveToTwitch"/>
              <span class="image-name">Twitch</span>
            </div>
            <div class="app-item">
              <img :src="radio_france" @click="moveToRadioFrance"/>
              <span class="image-name">Radio France</span>
            </div>
            <div class="app-item">
              <img :src="spotify" @click="moveToSpotify"/>
              <span class="image-name">Spotify</span>
            </div>
            <div class="app-item">
              <img :src="youtube" @click="moveToYoutube"/>
              <span class="image-name">Youtube</span>
            </div>
            <div class="app-item">
              <img :src="gmail" @click="moveToGmail"/>
              <span class="image-name">Gmail</span>
            </div>
            <div class="app-item">
              <img :src="google_drive" @click="moveToGoogleDrive"/>
